...
(function (root) {
  ...
  root.MIXIN_LIGHTING = {
    ...
    // комнаты, теми же вложенными плоскими слоями («пиксельный» спад). Не
    // привязан к выключателю (это уличный/лунный свет, не электричество), но
    // задёрнутая штора (this.curtainClosed(), room/shell.js) его всё же
