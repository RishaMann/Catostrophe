...
export const DIR_SPRITES: DirSprite[] = [
  { frames: WALK_FRONT, flip: true, idle: "sit_front_a" }, // front-right — зеркало front-left
  { frames: WALK_FRONT, flip: false, idle: "sit_front_a" }, // toward-viewer — своего кадра нет, берём front-left как есть
  { frames: WALK_FRONT, flip: false, idle: "sit_front_a" }, // front-left — прямое совпадение
  { frames: WALK_BACK, flip: true, idle: "sit_back_a" }, // back-left (влево-вверх) — зеркало, иначе кот шёл задом
  { frames: WALK_AWAY, flip: false, idle: "sit_back_a" }, // away-from-viewer — прямое совпадение (кадр «прямо в спину»)
  { frames: WALK_BACK, flip: false, idle: "sit_back_a" }, // back-right (вправо-вверх) — как есть, иначе кот шёл задом
];
